...
// Dynamic import with ssr:false is REQUIRED for Three.js/R3F components
// They use browser-only APIs (WebGL, window) that crash during SSR on Vercel
const ParticleBackground = dynamic(
  () => import('@/components/animation/ParticleBackground').then(mod => ({ default: mod.ParticleBackground })),
  { ssr: false }
)
